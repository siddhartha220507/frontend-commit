        ...
        <div style={{ display: 'flex', minHeight: '100vh', background: '#e5e7eb' }}>
            ...
            <div style={{ flex: 1, backgroundColor: '#ffffff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 10%', borderTopLeftRadius: '30px', borderBottomLeftRadius: '30px', boxShadow: '-10px 0 30px rgba(0,0,0,0.05)' }}>
                <div style={{ maxWidth: '400px', width: '100%', margin: '0 auto' }}>
                    ...
                    <h2 style={{ fontSize: '2.5rem', fontWeight: '900', color: '#111', marginBottom: '0.5rem', textAlign: 'center', fontFamily: "'Helvetica Neue', sans-serif" }}>Create Account</h2>
                    <p style={{ color: '#666', textAlign: 'center', marginBottom: '2.5rem', fontSize: '0.95rem' }}>Join us and start discovering movies</p>
                    
                   {isError && <p style={{ color: 'var(--primary-color)', textAlign: 'center', marginBottom: '1rem', fontWeight: 'bold' }}>{message}</p>}
                    
                    <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        <div>
                           <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: '600', color: '#333', marginBottom: '0.5rem' }}>Username</label>
                            <input 
                        ...
                        <div>
                            <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: '600', color: '#333', marginBottom: '0.5rem' }}>Email</label>
                           <input 
                        ...
                        <div>
                           <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: '600', color: '#333', marginBottom: '0.5rem' }}>Confirm Password</label>
                            <input 
                    ...
                    <p style={{ textAlign: 'center', marginTop: '2rem', color: '#666', fontSize: '0.9rem' }}>
                       Already have an account? <Link to="/login" style={{ color: '#111', fontWeight: 'bold', textDecoration: 'none' }}>Log in</Link>
                    </p>
                </div>
            </div>
        </div>
